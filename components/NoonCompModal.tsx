...
export default function NoonCompModal({
  isVisible,
  onClose,
  competitionName,
  competitionId,
  ...
  const checkCompetitionStatus = async () => {
    ...
    try {
      const status = await getCompetitionStatus('noon');
      ...
      <View className="flex-1 items-center justify-center bg-black/50">
        <View
          ...
          <Text className="mb-4 mt-4 text-2xl font-bold text-black">
            {competitionName || 'Noon Competition'}
          </Text>

          {/* Description */}
          <Text className="mb-8 text-lg text-black">
            Ready to show off your lunch skills? Join this exciting lunch competition and
